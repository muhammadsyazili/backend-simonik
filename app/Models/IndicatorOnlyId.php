...
class IndicatorOnlyId extends Model
{
    ...
    * Get the value indicating whether the IDs are incrementing.
    ...
    {
        return $this->hasMany(IndicatorOnlyId::class, 'parent_vertical_id', 'id');
    }
    ...
    {
        return $this->hasMany(IndicatorOnlyId::class, 'parent_horizontal_id', 'id')->referenced();
    }
    ...
    {
        return $this->belongsTo(IndicatorOnlyId::class, 'parent_vertical_id', 'id');
    }

    public function parentHorizontal()
    {
        return $this->belongsTo(IndicatorOnlyId::class, 'parent_horizontal_id', 'id');
    }
